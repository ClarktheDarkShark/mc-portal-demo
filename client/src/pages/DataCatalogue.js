...
function DataCatalogue() {
  ...
  const [selectedSection, setSelectedSection] = useState('dataRepository'); // "dataRepository" or "dataTools"
    ...
    fetch('/api/repository/data')
      ...
      .then((data) => {
        ...
        if (
          data &&
          data.dataRepository &&
          data.dataRepository.categories &&
    ...
    <Box sx={{ padding: '2rem' }}>
      ...
      <FormControl fullWidth sx={{ mb: 2 }}>
        ...
        >
          ...
          <MenuItem value="dataTools">Data Tools</MenuItem>
        </Select>
      </FormControl>
      ...
      {/* If Data Tools is selected, show its details */}
      {selectedSection === 'dataTools' && (
        <Box>
          <Typography variant="h5" gutterBottom>
            {dataCatalogue.dataTools.name}
          </Typography>
          <Typography variant="body1" sx={{ mb: 1 }}>
            {dataCatalogue.dataTools.description}
          </Typography>
          <Typography variant="body1">
            <a
              href={dataCatalogue.dataTools.link}
              target="_blank"
              rel="noopener noreferrer"
            >
              [Link]
